//
//  DomainEatingTag+CoreDataProperties.swift
//  
//
...
extension DomainEatingTag {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<DomainEatingTag> {
        return NSFetchRequest<DomainEatingTag>(entityName: "DomainEatingTag")
    }
