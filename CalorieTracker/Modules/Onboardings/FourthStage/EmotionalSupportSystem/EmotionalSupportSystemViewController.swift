//
//  EmotionalSupportSystemViewController.swift
//  CalorieTracker
//
...
final class EmotionalSupportSystemViewController: UIViewController {
    ...
    var presenter: EmotionalSupportSystemPresenterInterface?
...
extension EmotionalSupportSystemViewController: EmotionalSupportSystemViewControllerInterface {
    func set(emotionalSupportSystem: [EmotionalSupportSystem]) {
        ...
        for emotionalSupportSystem in emotionalSupportSystem {
            let answerOption = AnswerOption(text: emotionalSupportSystem.description)
...
// MARK: - EmotionalSupportSystem + description

fileprivate extension EmotionalSupportSystem {
    var description: String {
        switch self {
        case .haveSomeCanLeanOnForSupport:
            return "I have some I can lean on for support"
        case .knowWhereCanGoForsupportWhenNeedIt:
            return "I know where I can go for support \nwhen I need it"
