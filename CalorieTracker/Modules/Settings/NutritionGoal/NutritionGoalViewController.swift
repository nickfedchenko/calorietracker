...
protocol NutritionGoalViewControllerInterface: AnyObject {
    func updateCell(_ type: GoalsSettingsCategoryType)
    var needUpdate: (() -> Void)? { get set }
}

final class NutritionGoalViewController: UIViewController {
    var presenter: NutritionGoalPresenterInterface?
...
extension NutritionGoalViewController: NutritionGoalViewControllerInterface {
    func updateCell(_ type: GoalsSettingsCategoryType) {
...
extension NutritionGoalViewController: UICollectionViewDelegateFlowLayout {
...
extension NutritionGoalViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .activityLevel:
            presenter?.didTapCell(.activityLevel)
        default:
...
extension NutritionGoalViewController: UICollectionViewDataSource {
...
extension NutritionGoalViewController {
